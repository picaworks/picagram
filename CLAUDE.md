...
- Reviewing is a separate agent's job, against `STYLE.md` and the captures. A `revise` note becomes the brief for a fresh worker, never a correction sent to the one that wrote it.
