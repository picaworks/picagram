...
> A hierarchy trail with native links, a distinct current page, and middle items that expand on demand.

Category: ui. Tags: breadcrumb, navigation, hierarchy, ui. Static. Size: 1.8 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/picagram/blob/main/LICENSE.md.

## Install

```bash
npx shadcn@latest add https://picagram.dev/r/breadcrumb.json
```
...
|---|---|---|---|
| `items` | readonly BreadcrumbItem[] | `[{"label":"Home","href":"#"},{"label":"Catalog","href":"#"},{"label":"Wave 6","href":"#"},{"label":"UI","href":"#"},{"label":"Breadcrumb","href":"#"}]` | The hierarchy to show, with the final item treated as the current page. |
| `maxItems` | number | `4` | The greatest number of entries shown before the middle is collapsed behind an ellipsis. |
| `label` | string | `"Breadcrumb"` | The accessible name of the navigation landmark. An empty label hides the component. |
...
// registry/ui/breadcrumb/core.ts
...
// registry/ui/breadcrumb/index.tsx
...
var PicaBreadcrumb = (() => {
  ...
  function breadcrumbRules(selector, hidden) {
    const fg = cssVar("fg");
    const muted = cssVar("muted");
    const accent = cssVar("accent");
    return [
  ...
  function breadcrumbElement(tag) {
    const element = document.createElement(tag);
    element.setAttribute("data-pica", "");
    return element;
  }
...
(function () {
  ...
  var instance = PicaBreadcrumb.mount(host, take(window.PICA_PROPS || {}));
