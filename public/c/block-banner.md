...
Category: text-mode. Tags: text, logotype, static, pixel font. Static. Size: 2.9 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/pica/blob/main/LICENSE.md.

## Install

```bash
npx shadcn@latest add https://raw.githubusercontent.com/rishabbalak/pica/main/public/r/block-banner.json
```
...
(function () {
  var instance = PicaBlockBanner.mount(document.getElementById("pica"), window.PICA_PROPS || {});
