...
Category: effects. Tags: image, static, duotone, canvas. Static. Size: 3.3 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/picagram/blob/main/LICENSE.md.

## Install

```bash
npx shadcn@latest add https://rishabbalak.github.io/picagram/r/duotone-image.json
```
