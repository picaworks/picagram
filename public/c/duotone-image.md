...
Category: effects. Tags: image, static, duotone, canvas. Static. Size: 2.2 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/pica/blob/main/LICENSE.md.

## Install

```bash
npx shadcn@latest add https://raw.githubusercontent.com/rishabbalak/pica/main/public/r/duotone-image.json
```
...
| `levels` | number | `4` | Flat tone bands the image's ink is quantized into. |
| `accent` | boolean | `false` | Draws the band with the most ink in --pica-accent instead of the host's ink color. |
...
// Pica · Duotone Image · duotone-image
...
// registry/effects/duotone-image/core.ts
...
// registry/effects/duotone-image/index.tsx
...
<title>Duotone Image · Pica</title>
...
(function () {
  var instance = PicaDuotoneImage.mount(document.getElementById("pica"), window.PICA_PROPS || {});
