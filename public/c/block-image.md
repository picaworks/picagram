...
Category: text-mode. Tags: image, static, quadrant blocks, ordered dither. Static. Size: 4.6 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/pica/blob/main/LICENSE.md.
...
(function () {
  ...
  var instance = PicaBlockImage.mount(host, take(window.PICA_PROPS || {}));
