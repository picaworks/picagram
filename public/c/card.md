...
> A hairline frame gives page content an optional heading and a compact row of linked actions.

Category: ui. Tags: card, content, links, ui. Static. Size: 1.8 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/picagram/blob/main/LICENSE.md.

## Install

```bash
npx shadcn@latest add https://picagram.dev/r/card.json
```
...
|---|---|---|---|
| `kicker` | string | `"WAVE 6"` | A short label above the title. An empty value removes the label. |
| `title` | string | `"Ship the draft"` | The card heading. An empty value removes the heading. |
| `actions` | readonly CardAction[] | `[{"label":"Review","href":"#"},{"label":"History","href":"#"}]` | Footer links. An empty list removes the footer. |
...
<body>
<div id="pica"><p>Keep the details close, then choose what should happen next.</p></div>
<script>
"use strict";
var PicaCard = (() => {
...
(function () {
  ...
  var instance = PicaCard.mount(host, take(window.PICA_PROPS || {}));
