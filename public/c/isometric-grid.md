...
> A quiet isometric lattice of equilateral triangles that can resolve into staggered drafting points.

Category: patterns. Tags: isometric, grid, lattice, dots, css. Static. Size: 1.3 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/picagram/blob/main/LICENSE.md.

## Install

```bash
npx shadcn@latest add https://picagram.dev/r/isometric-grid.json
```
...
|---|---|---|---|
| `spacing` | number | `24` | Perpendicular distance between parallel rules, in pixels. |
| `dots` | boolean | `false` | Draws points at the lattice vertices instead of rules. |
| `strength` | number | `0.35` | Opacity of the pattern layer, from quiet to full ink. |
...
// Pica · Isometric Grid · isometric-grid
...
// registry/patterns/isometric-grid/core.ts
...
// registry/patterns/isometric-grid/index.tsx
...
<title>Isometric Grid · Pica</title>
...
<body>
<div id="pica"><h2>ISOMETRIC FIELD</h2><p>Three measured axes form one quiet structure.</p></div>
<script>
"use strict";
var PicaIsometricGrid = (() => {
...
(function () {
  ...
  var instance = PicaIsometricGrid.mount(host, take(window.PICA_PROPS || {}));
