...
|---|---|---|---|
| `text` | string | `"Drawn on a monospace grid."` | Text to reveal. Assistive technology reads it whole, never the scramble. |
...
(function () {
  ...
  var instance = PicaAsciiReveal.mount(host, take(window.PICA_PROPS || {}));
