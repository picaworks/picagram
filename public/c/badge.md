...
Category: ui. Tags: badge, status, label, version, ui. Static. Size: 1.2 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/picagram/blob/main/LICENSE.md.

## Install

```bash
npx shadcn@latest add https://picagram.dev/r/badge.json
```
...
|---|---|---|---|
| `text` | string | `"STABLE"` | The status text shown by the badge. |
| `variant` | "outline" \| "solid" \| "brackets" | `"outline"` | The frame drawn around the status text. |
| `tone` | "fg" \| "muted" \| "accent" | `"accent"` | The palette tone used for the frame or fill. |
...
var PicaBadge = (() => {
  ...
  function badgeRules(selector, props) {
...
(function () {
  ...
  var instance = PicaBadge.mount(host, take(window.PICA_PROPS || {}));
