...
Category: sections. Tags: hero, minimal, landing, section, cta. Static. Size: 1.9 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/picagram/blob/main/LICENSE.md.

## Install

```bash
npx shadcn@latest add https://picagram.dev/r/minimal-hero.json
```
...
|---|---|---|---|
| `headline` | string | `"Less, but better."` | The one idea, drawn as a large heading after anything the page wraps. Empty draws none. |
| `subhead` | string | `"A headline, one line of support, and a single way forward."` | At most one line of support, drawn in the muted color under the headline. Empty draws none. |
| `actions` | readonly MinimalHeroAction[] | `[{"label":"Get started","href":"#"}]` | Calls to action, drawn as links. At most three: the first draws solid, the rest outline. |
| `align` | "start" \| "center" | `"start"` | Horizontal alignment of the content block within the host. |
...
// Pica · Minimal Hero · minimal-hero
...
// registry/sections/minimal-hero/core.ts
...
// registry/sections/minimal-hero/index.tsx
...
<body>
<div id="pica"><h1>One idea, set large.</h1></div>
<script>
"use strict";
var PicaMinimalHero = (() => {
