...
Category: dither. Tags: image, static, dither, canvas. Static. Size: 2.5 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/pica/blob/main/LICENSE.md.
...
(function () {
  var instance = PicaDitherImage.mount(document.getElementById("pica"), window.PICA_PROPS || {});
