...
> Fine diagonal rules form a quiet drafting ground behind page content.

Category: patterns. Tags: stripes, diagonal, rules, background, css. Static. Size: 1.2 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/picagram/blob/main/LICENSE.md.

## Install

```bash
npx shadcn@latest add https://picagram.dev/r/diagonal-stripes.json
```
...
|---|---|---|---|
| `angle` | number | `45` | Angle of the rules, in degrees. |
| `spacing` | number | `14` | Distance from the start of one rule to the next, in pixels. |
| `thickness` | number | `1` | Thickness of each rule, in pixels. Never drawn thicker than half the spacing. |
| `strength` | number | `0.35` | Opacity of the stripe layer, from quiet to full strength. |
...
// Pica · Diagonal Stripes · diagonal-stripes
...
// registry/patterns/diagonal-stripes/core.ts
...
// registry/patterns/diagonal-stripes/index.tsx
...
<title>Diagonal Stripes · Pica</title>
...
<body>
<div id="pica"><h2>Field Notes</h2><p>Measured diagonals establish a quiet ground.</p></div>
<script>
"use strict";
var PicaDiagonalStripes = (() => {
...
(function () {
  ...
  var instance = PicaDiagonalStripes.mount(host, take(window.PICA_PROPS || {}));
