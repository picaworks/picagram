...
Category: ascii. Tags: background, noise, animated, decorative. Animated. Holds a still frame under prefers-reduced-motion, and stops offscreen and in hidden tabs. Size: 4.6 KB gzipped, runtime included. License: MIT + Commons Clause, https://github.com/rishabbalak/pica/blob/main/LICENSE.md.
...
(function () {
  ...
  var instance = PicaAsciiNoiseField.mount(host, take(window.PICA_PROPS || {}));
